...
#pragma warning restore 649
        ...
        [SerializeField]
        private string participant1ID = "1";

        [SerializeField]
        private string participant2ID = "2";
        ...
        public string FileName {
            get { return fileNamePrefix + "_" + participant1ID + "_" + participant2ID + fileNameSuffix; }
        }
        ...
        private void Start() {
            HandleEnableOnPlay();
            LogString("Launching experiment for participants " + participant1ID + " and " + participant2ID);
        }
